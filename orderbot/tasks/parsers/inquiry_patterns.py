...
ATTRIBUTE_INQUIRY_PATTERNS = [
    ...
    # "what bagel flavors are there?" / "what bagel types are available?" / "what bagel kinds do you offer?"
...
AVAILABILITY_PATTERNS = [
    ...
    # Anchored to start (^) to avoid matching mid-sentence in questions like
    # "what menu items do you have with egg whites?"
