...
- Cache infrastructure (ensure_cache_loaded decorator, index builders)
- BaseCacheMixin with cache attribute initialization
- Re-exports from focused sub-modules (text_utils, constants, pluralization)
"""
...
from .pluralization import (  # noqa: F401 — re-exported
    singularize,
    pluralize,
    get_singular_plural_variants,
    contains_word_or_singular,
)
