...
from .crud_helpers import make_list_builder, apply_payload_updates
...
def _handle_before_update(item, payload, db):
    """Apply update payload to item with normalization and modifier_type null-coercion."""
