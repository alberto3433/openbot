...
from ..quantity_utils import extract_leading_quantity as _extract_leading_quantity, strip_quantity_modifier_prefix
...
def _is_demotable_to_modifier(token: "Token") -> bool:
    ...
    check_text = strip_quantity_modifier_prefix(check_text)
