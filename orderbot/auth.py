"""
Authentication Module for Orderbot
======================================

This module handles authentication for protected endpoints in the Orderbot
...
Add authentication to any endpoint using FastAPI's Depends():
    ...
    from orderbot.auth import verify_admin_credentials
